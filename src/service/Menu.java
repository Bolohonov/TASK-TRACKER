...
enum Menu {
    ...
    THREE("3 - Получить список всех задач"),
    ...
    EIGHT("8 - Удалить все задачи, эпики и подзадачи"),
    NINE("9 - Удалить задачу по идентификатору"),
    TEN("10 - Получить историю просмотров задач"),
